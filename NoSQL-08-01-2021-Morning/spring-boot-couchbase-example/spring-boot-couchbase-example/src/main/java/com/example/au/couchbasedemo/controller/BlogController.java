...
public class BlogController {
    ...
    @GetMapping("/blogs/publisher/{publisher}")
    public List<Blogs> getBlogByPublisherName(@PathVariable String publisher) {

        return blogRepository.findByPublisher(publisher);
    }

    @GetMapping("/blogs/forKids/{forKids}")
    public List<Blogs> getBlogByforKids(@PathVariable Boolean forKids) {

        return blogRepository.findByKids(forKids);
    }
	/*
